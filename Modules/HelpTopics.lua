...
function TA_Help_ShowTopic(topicArg)
  ...
  if key == "quests" then
    ...
    AddLine("system", "  route - next 3 Guidelime steps (requires Guidelime + bridge patch).")
    AddLine("system", "  route <n> - next n Guidelime steps.")
    AddLine("system", "  route skip - advance past current Guidelime step.")
    AddLine("system", "  route back - undo most recent skip/completion.")
    AddLine("system", "  route status - currently loaded guide and progress.")
